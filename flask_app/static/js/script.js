...
function setAlarm() {
    ...
    if(hm) {
        ...
        if (timeToAlarm > current) {
            ...
            alarmTimeout = setTimeout(() => audio.play(), timeout);// set timeout to variable so user can clear alarm before it goes off if they choose.  Using a promise to set alarm. asynnchorus action promises to return value in the future
            alert('Alarm set');
        }
    }
}
